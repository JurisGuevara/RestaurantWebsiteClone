...
var cardOpen = [false,false,false,false,false,false,false]
var allFlipCards = document.querySelectorAll('.flip-card')

function flipCard(index){
	if(cardOpen[index] == false){
		allFlipCards[index].style.transform = 'rotateY(180deg)'
		cardOpen[index] = true
	}else{
		allFlipCards[index].style.transform = 'rotateY(360deg)'
		cardOpen[index] = false
	}
}
